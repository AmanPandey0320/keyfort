...
/**
 * TRIE based url matched for validating redirect url
 *
 * <p>HOW IT WORKS: A spring component intializes has a post construct method which reads all
 * redirect uris of all clients from db and populates them in trie at the end of every trie node
 * where the url ends it has clientid and if after matching url, it returns the clientid of the
 * redirect uri
 */
@Component
